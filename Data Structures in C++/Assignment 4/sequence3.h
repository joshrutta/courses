// PROVIDED BY: Josh Rutta joshrutta7@gmail.com (your name and email address)
// FILE: sequence3.h
...
namespace main_savitch_5
{
    ...
    public:
        ...
        value_type current( ) const{assert(is_item()); return cursor->data();}
    private:
	node *head_ptr, *tail_ptr, *cursor, *precursor;
